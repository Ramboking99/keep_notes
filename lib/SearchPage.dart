                ...
                child: StaggeredGridView.countBuilder(
                    ...
                    itemBuilder: (context, index) =>
                        InkWell(
                          onTap: ()
                          {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => NoteView(note: SearchResultNotes[index] ?? Note(pin: false, title: "", content: "", createdTime: DateTime.now(), isArchive: false, uniqueID: "0", noteColor: ""))));
                          },
                          child:
                          Container(
                            padding: EdgeInsets.all(10),
                            decoration: BoxDecoration(
                                color: SearchResultNotes[index]?.noteColor == "bgColor" ? cardColor : Color(NoteColors[SearchResultNotes[index]?.noteColor]!['b'] ?? 0xFF2D2E33),
                                border: Border.all(color: SearchResultNotes[index]?.noteColor == "bgColor" ? white.withOpacity(0.4) : Color(NoteColors[SearchResultNotes[index]?.noteColor]!['b'] ?? 0xFFFFFFFF)),
